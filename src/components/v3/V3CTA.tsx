...
export default function V3CTA() {
  return (
    <section id="contact" className="py-14 px-6 text-center">
      ...
      <h2 style={{ fontFamily: "'Fraunces', serif" }} className="text-[32px] font-medium text-[#FAFAF9] leading-[1.15] tracking-[-0.5px] mb-4">
        Need expert<br />guidance?
      </h2>
      <p className="text-sm text-[#6B6B70] leading-[1.6] max-w-xs mx-auto mb-8">
